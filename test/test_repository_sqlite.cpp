...
TEST_SUITE("SQLiteCarSearchRepository Test Suite") {
    TEST_CASE_FIXTURE(test::helper::ManyCarsFixture,
                      "SQLiteCarSearchRepository inserts "
    ...
    TEST_CASE(
        ...
        const std::string name = "Test Search";
        const std::string url = "http://example.com/test_search";
        repository.insertCarsForSearch(
            searchId, name, url,
        ...
        CHECK_EQ(std::chrono::duration_cast<std::chrono::seconds>(
                     cars[0].timestamp.time_since_epoch())
                     .count(),
                 std::chrono::duration_cast<std::chrono::seconds>(
                     test::helper::WORST_CAR.timestamp.time_since_epoch())
                     .count());
        ...
        CHECK_EQ(
            std::chrono::duration_cast<std::chrono::seconds>(
                cars[0].firstRegistration.time_since_epoch())
                .count(),
            std::chrono::duration_cast<std::chrono::seconds>(
                test::helper::WORST_CAR.firstRegistration.time_since_epoch())
                .count());
        ...
        CHECK_EQ(std::chrono::duration_cast<std::chrono::seconds>(
                     cars[0].advertisedSince.time_since_epoch())
                     .count(),
                 std::chrono::duration_cast<std::chrono::seconds>(
                     test::helper::WORST_CAR.advertisedSince.time_since_epoch())
                     .count());
        CHECK_EQ(cars[0].isPrivateSeller,
                 test::helper::WORST_CAR.isPrivateSeller);
        ...
        CHECK_EQ(std::chrono::duration_cast<std::chrono::seconds>(
                     cars[1].timestamp.time_since_epoch())
                     .count(),
                 std::chrono::duration_cast<std::chrono::seconds>(
                     test::helper::BEST_CAR.timestamp.time_since_epoch())
                     .count());
        ...
        CHECK_EQ(
            std::chrono::duration_cast<std::chrono::seconds>(
                cars[1].firstRegistration.time_since_epoch())
                .count(),
            std::chrono::duration_cast<std::chrono::seconds>(
                test::helper::BEST_CAR.firstRegistration.time_since_epoch())
                .count());
        ...
        CHECK_EQ(std::chrono::duration_cast<std::chrono::seconds>(
                     cars[1].advertisedSince.time_since_epoch())
                     .count(),
                 std::chrono::duration_cast<std::chrono::seconds>(
                     test::helper::BEST_CAR.advertisedSince.time_since_epoch())
                     .count());
        CHECK_EQ(cars[1].isPrivateSeller,
                 test::helper::BEST_CAR.isPrivateSeller);
