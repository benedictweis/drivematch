...
void CarsAnalyzer::setWeightsAndFilters(
    float weightHp,
    float weightPrice,
    float weightMileage,
    float weightAge,
...
void CarsAnalyzer::calculateMinMaxValues() {
    ...
    for (const Car& car : cars) {
        ...
        if (advertisementAgeDays < minAdvertisementAge) minAdvertisementAge = advertisementAgeDays;
        if (advertisementAgeDays > maxAdvertisementAge) maxAdvertisementAge = advertisementAgeDays;
    }
}
